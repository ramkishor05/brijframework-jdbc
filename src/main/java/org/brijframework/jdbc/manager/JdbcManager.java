...
public class JdbcManager {
	...
	public static boolean alterColumnName(String id,String colname) throws Exception {
		...
		JdbcCatalog catalog=table.getCatalog();
		...
		String query="ALTER TABLE "+catalog.getTableCat()+"."+table.getTableName() +" CHANGE "+column.getColumnName()+"  "+colname+" "+column.getDataType();
