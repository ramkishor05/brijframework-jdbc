...
public enum JdbcSqlType implements SQLType {
     ...
     */
    DECIMAL("DECIMAL", Types.DECIMAL, BigDecimal.class, JdbcSqlType.FIELD_FLAG_ZEROFILL, JdbcSqlType.IS_DECIMAL, 65L, "[(M[,D])] [UNSIGNED] [ZEROFILL]"),
    /**
     * DECIMAL[(M[,D])] UNSIGNED [ZEROFILL]
     * 
     * @see MysqlType#DECIMAL
     */
    DECIMAL_UNSIGNED("DECIMAL UNSIGNED", Types.DECIMAL, BigDecimal.class, JdbcSqlType.FIELD_FLAG_UNSIGNED | JdbcSqlType.FIELD_FLAG_ZEROFILL, JdbcSqlType.IS_DECIMAL,
     ...
     */
    TINYINT("TINYINT", Types.TINYINT, Integer.class, JdbcSqlType.FIELD_FLAG_ZEROFILL, JdbcSqlType.IS_DECIMAL, 3L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * TINYINT[(M)] UNSIGNED [ZEROFILL]
     * 
     * @see MysqlType#TINYINT
     */
    TINYINT_UNSIGNED("TINYINT UNSIGNED", Types.TINYINT, Integer.class, JdbcSqlType.FIELD_FLAG_UNSIGNED | JdbcSqlType.FIELD_FLAG_ZEROFILL, JdbcSqlType.IS_DECIMAL, 3L,
            "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * BOOL, BOOLEAN
     ...
     * Protocol: FIELD_TYPE_TINY = 1
     */
    BOOLEAN("BOOLEAN", Types.BOOLEAN, Boolean.class, 0, JdbcSqlType.IS_NOT_DECIMAL, 3L, ""),
    /**
     ...
     */
    SMALLINT("SMALLINT", Types.SMALLINT, Integer.class, JdbcSqlType.FIELD_FLAG_ZEROFILL, JdbcSqlType.IS_DECIMAL, 5L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * SMALLINT[(M)] UNSIGNED [ZEROFILL]
     * 
     * @see MysqlType#SMALLINT
     */
    SMALLINT_UNSIGNED("SMALLINT UNSIGNED", Types.SMALLINT, Integer.class, JdbcSqlType.FIELD_FLAG_UNSIGNED | JdbcSqlType.FIELD_FLAG_ZEROFILL, JdbcSqlType.IS_DECIMAL,
     ...
     */
    INT("INT", Types.INTEGER, Integer.class, JdbcSqlType.FIELD_FLAG_ZEROFILL, JdbcSqlType.IS_DECIMAL, 10L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * INT[(M)] UNSIGNED [ZEROFILL]
     * 
     * @see MysqlType#INT
     */
    INT_UNSIGNED("INT UNSIGNED", Types.INTEGER, Long.class, JdbcSqlType.FIELD_FLAG_UNSIGNED | JdbcSqlType.FIELD_FLAG_ZEROFILL, JdbcSqlType.IS_DECIMAL, 10L,
            "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     ...
     */
    FLOAT("FLOAT", Types.REAL, Float.class, JdbcSqlType.FIELD_FLAG_ZEROFILL, JdbcSqlType.IS_DECIMAL, 12L, "[(M,D)] [UNSIGNED] [ZEROFILL]"),
    /**
     * FLOAT[(M,D)] UNSIGNED [ZEROFILL]
     * 
     * @see MysqlType#FLOAT
     */
    FLOAT_UNSIGNED("FLOAT UNSIGNED", Types.REAL, Float.class, JdbcSqlType.FIELD_FLAG_UNSIGNED | JdbcSqlType.FIELD_FLAG_ZEROFILL, JdbcSqlType.IS_DECIMAL, 12L,
     ...
     */
    DOUBLE("DOUBLE", Types.DOUBLE, Double.class, JdbcSqlType.FIELD_FLAG_ZEROFILL, JdbcSqlType.IS_DECIMAL, 22L, "[(M,D)] [UNSIGNED] [ZEROFILL]"),
    /**
     * DOUBLE[(M,D)] UNSIGNED [ZEROFILL]
     * 
     * @see MysqlType#DOUBLE
     */
    DOUBLE_UNSIGNED("DOUBLE UNSIGNED", Types.DOUBLE, Double.class, JdbcSqlType.FIELD_FLAG_UNSIGNED | JdbcSqlType.FIELD_FLAG_ZEROFILL, JdbcSqlType.IS_DECIMAL, 22L,
            "[(M,D)] [UNSIGNED] [ZEROFILL]"),
    /**
     * FIELD_TYPE_NULL = 6
     */
    NULL("NULL", Types.NULL, Object.class, 0, JdbcSqlType.IS_NOT_DECIMAL, 0L, ""),
    /**
     * TIMESTAMP[(fsp)]
    ...
    TIMESTAMP("TIMESTAMP", Types.TIMESTAMP, Timestamp.class, 0, JdbcSqlType.IS_NOT_DECIMAL, 26L, "[(fsp)]"),
    /**
     ...
     */
    BIGINT("BIGINT", Types.BIGINT, Long.class, JdbcSqlType.FIELD_FLAG_ZEROFILL, JdbcSqlType.IS_DECIMAL, 19L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * BIGINT[(M)] UNSIGNED [ZEROFILL]
     * 
     * @see MysqlType#BIGINT
     */
    BIGINT_UNSIGNED("BIGINT UNSIGNED", Types.BIGINT, BigInteger.class, JdbcSqlType.FIELD_FLAG_UNSIGNED | JdbcSqlType.FIELD_FLAG_ZEROFILL, JdbcSqlType.IS_DECIMAL, 20L,
            "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     ...
     */
    MEDIUMINT("MEDIUMINT", Types.INTEGER, Integer.class, JdbcSqlType.FIELD_FLAG_ZEROFILL, JdbcSqlType.IS_DECIMAL, 7L, "[(M)] [UNSIGNED] [ZEROFILL]"),
    /**
     * MEDIUMINT[(M)] UNSIGNED [ZEROFILL]
     * 
     * @see MysqlType#MEDIUMINT
     */
    MEDIUMINT_UNSIGNED("MEDIUMINT UNSIGNED", Types.INTEGER, Integer.class, JdbcSqlType.FIELD_FLAG_UNSIGNED | JdbcSqlType.FIELD_FLAG_ZEROFILL, JdbcSqlType.IS_DECIMAL,
     ...
     */
    DATE("DATE", Types.DATE, Date.class, 0, JdbcSqlType.IS_NOT_DECIMAL, 10L, ""),
    /**
     * TIME[(fsp)]
     ...
     */
    TIME("TIME", Types.TIME, Time.class, 0, JdbcSqlType.IS_NOT_DECIMAL, 16L, "[(fsp)]"),
    /**
     * DATETIME[(fsp)]
     ...
     */
    DATETIME("DATETIME", Types.TIMESTAMP, Timestamp.class, 0, JdbcSqlType.IS_NOT_DECIMAL, 26L, "[(fsp)]"),
    /**
     * YEAR[(4)]
     ...
     */
    YEAR("YEAR", Types.DATE, Date.class, 0, JdbcSqlType.IS_NOT_DECIMAL, 4L, "[(4)]"),
    /**
     ...
     */
    VARCHAR("VARCHAR", Types.VARCHAR, String.class, 0, JdbcSqlType.IS_NOT_DECIMAL, 65535L, "(M) [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * VARBINARY(M)
     ...
     * Protocol: FIELD_TYPE_VAR_STRING = 253
     */
    VARBINARY("VARBINARY", Types.VARBINARY, null, 0, JdbcSqlType.IS_NOT_DECIMAL, 65535L, "(M)"),
    /**
     * BIT[(M)]
     * A bit-field type. M indicates the number of bits per value, from 1 to 64. The default is 1 if M is omitted.
     * Protocol: FIELD_TYPE_BIT = 16
     */
    BIT("BIT", Types.BIT, Boolean.class, 0, JdbcSqlType.IS_DECIMAL, 1L, "[(M)]"), // TODO maybe precision=8 ?
    /**
     ...
     */
    JSON("JSON", Types.LONGVARCHAR, String.class, 0, JdbcSqlType.IS_NOT_DECIMAL, 1073741824L, ""),
    /**
     ...
     */
    ENUM("ENUM", Types.CHAR, String.class, 0, JdbcSqlType.IS_NOT_DECIMAL, 65535L,
     ...
     */
    SET("SET", Types.CHAR, String.class, 0, JdbcSqlType.IS_NOT_DECIMAL, 64L, "('value1','value2',...) [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * TINYBLOB
     ...
     */
    TINYBLOB("TINYBLOB", Types.VARBINARY, null, 0, JdbcSqlType.IS_NOT_DECIMAL, 255L, ""),
    /**
     ...
     * Protocol:FIELD_TYPE_TINY_BLOB = 249
     */
    TINYTEXT("TINYTEXT", Types.VARCHAR, String.class, 0, JdbcSqlType.IS_NOT_DECIMAL, 255L, " [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * MEDIUMBLOB
     ...
     */
    MEDIUMBLOB("MEDIUMBLOB", Types.LONGVARBINARY, null, 0, JdbcSqlType.IS_NOT_DECIMAL, 16777215L, ""),
    /**
     ...
     * Protocol: FIELD_TYPE_MEDIUM_BLOB = 250
     */
    MEDIUMTEXT("MEDIUMTEXT", Types.LONGVARCHAR, String.class, 0, JdbcSqlType.IS_NOT_DECIMAL, 16777215L, " [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * LONGBLOB
     ...
     */
    LONGBLOB("LONGBLOB", Types.LONGVARBINARY, null, 0, JdbcSqlType.IS_NOT_DECIMAL, 4294967295L, ""),
    /**
     ...
     * Protocol: FIELD_TYPE_LONG_BLOB = 251
     */
    LONGTEXT("LONGTEXT", Types.LONGVARCHAR, String.class, 0, JdbcSqlType.IS_NOT_DECIMAL, 4294967295L, " [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * BLOB[(M)]
     ...
     */
    BLOB("BLOB", Types.LONGVARBINARY, null, 0, JdbcSqlType.IS_NOT_DECIMAL, 65535L, "[(M)]"),
    /**
     ...
     * Protocol: FIELD_TYPE_BLOB = 252
     */
    TEXT("TEXT", Types.LONGVARCHAR, String.class, 0, JdbcSqlType.IS_NOT_DECIMAL, 65535L, "[(M)] [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     ...
     */
    CHAR("CHAR", Types.CHAR, String.class, 0, JdbcSqlType.IS_NOT_DECIMAL, 255L, "[(M)] [CHARACTER SET charset_name] [COLLATE collation_name]"),
    /**
     * BINARY(M)
     ...
     */
    BINARY("BINARY", Types.BINARY, null, 0, JdbcSqlType.IS_NOT_DECIMAL, 255L, "(M)"),
    /**
     * Top class for Spatial Data Types
     * 
     * Protocol: FIELD_TYPE_GEOMETRY = 255
     */
    GEOMETRY("GEOMETRY", Types.BINARY, null, 0, JdbcSqlType.IS_NOT_DECIMAL, 65535L, ""), // TODO check precision, it isn't well documented, only mentioned that WKB format is represented by BLOB 
    /**
     ...
     * Has no protocol ID.
     */
    UNKNOWN("UNKNOWN", Types.OTHER, null, 0, JdbcSqlType.IS_NOT_DECIMAL, 65535L, "");
     ...
     * @return MysqlType
     */
    public static JdbcSqlType getByName(String fullMysqlTypeName) {
        ...
        if (StringUtil.indexOfIgnoreCase(typeName, "DECIMAL") != -1 || StringUtil.indexOfIgnoreCase(typeName, "DEC") != -1
                || StringUtil.indexOfIgnoreCase(typeName, "NUMERIC") != -1 || StringUtil.indexOfIgnoreCase(typeName, "FIXED") != -1) {
            return StringUtil.indexOfIgnoreCase(fullMysqlTypeName, "UNSIGNED") != -1 ? DECIMAL_UNSIGNED : DECIMAL;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "TINYBLOB") != -1) {
            // IMPORTANT: "TINYBLOB" must be checked before "TINY"
            return TINYBLOB;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "TINYTEXT") != -1) {
            // IMPORTANT: "TINYTEXT" must be checked before "TINY"
            return TINYTEXT;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "TINYINT") != -1 || StringUtil.indexOfIgnoreCase(typeName, "TINY") != -1
                || StringUtil.indexOfIgnoreCase(typeName, "INT1") != -1) {

            // TODO BOOLEAN is a synonym for TINYINT(1)
            return StringUtil.indexOfIgnoreCase(fullMysqlTypeName, "UNSIGNED") != -1 ? TINYINT_UNSIGNED : TINYINT;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "MEDIUMINT") != -1
                // IMPORTANT: "INT24" must be checked before "INT2"
                || StringUtil.indexOfIgnoreCase(typeName, "INT24") != -1 || StringUtil.indexOfIgnoreCase(typeName, "INT3") != -1
                || StringUtil.indexOfIgnoreCase(typeName, "MIDDLEINT") != -1) {
            return StringUtil.indexOfIgnoreCase(fullMysqlTypeName, "UNSIGNED") != -1 ? MEDIUMINT_UNSIGNED : MEDIUMINT;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "SMALLINT") != -1 || StringUtil.indexOfIgnoreCase(typeName, "INT2") != -1) {
            return StringUtil.indexOfIgnoreCase(fullMysqlTypeName, "UNSIGNED") != -1 ? SMALLINT_UNSIGNED : SMALLINT;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "BIGINT") != -1 || StringUtil.indexOfIgnoreCase(typeName, "SERIAL") != -1
                || StringUtil.indexOfIgnoreCase(typeName, "INT8") != -1) {
            // SERIAL is an alias for BIGINT UNSIGNED NOT NULL AUTO_INCREMENT UNIQUE.
            return StringUtil.indexOfIgnoreCase(fullMysqlTypeName, "UNSIGNED") != -1 ? BIGINT_UNSIGNED : BIGINT;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "POINT") != -1) {
        ...
        } else if (StringUtil.indexOfIgnoreCase(typeName, "INT") != -1 || StringUtil.indexOfIgnoreCase(typeName, "INTEGER") != -1
                || StringUtil.indexOfIgnoreCase(typeName, "INT4") != -1) {
            // IMPORTANT: "INT" must be checked after all "*INT*" types
            return StringUtil.indexOfIgnoreCase(fullMysqlTypeName, "UNSIGNED") != -1 ? INT_UNSIGNED : INT;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "DOUBLE") != -1 || StringUtil.indexOfIgnoreCase(typeName, "REAL") != -1
        /* || StringUtil.indexOfIgnoreCase(name, "DOUBLE PRECISION") != -1 is caught by "DOUBLE" check */
        // IMPORTANT: "FLOAT8" must be checked before "FLOAT"
                || StringUtil.indexOfIgnoreCase(typeName, "FLOAT8") != -1) {
            // TODO Exception: If the REAL_AS_FLOAT SQL mode is enabled, REAL is a synonym for FLOAT rather than DOUBLE.
            return StringUtil.indexOfIgnoreCase(fullMysqlTypeName, "UNSIGNED") != -1 ? DOUBLE_UNSIGNED : DOUBLE;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "FLOAT") != -1 /*
                                                                           * || StringUtil.indexOfIgnoreCase(name, "FLOAT4") != -1 is caught by
                                                                           * "FLOAT" check
                                                                           */) {
            ...
            return StringUtil.indexOfIgnoreCase(fullMysqlTypeName, "UNSIGNED") != -1 ? FLOAT_UNSIGNED : FLOAT;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "NULL") != -1) {
            return NULL;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "TIMESTAMP") != -1) {
            // IMPORTANT: "TIMESTAMP" must be checked before "TIME"
            return TIMESTAMP;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "DATETIME") != -1) {
            // IMPORTANT: "DATETIME" must be checked before "DATE" and "TIME"
            return DATETIME;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "DATE") != -1) {
            return DATE;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "TIME") != -1) {
            return TIME;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "YEAR") != -1) {
            return YEAR;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "LONGBLOB") != -1) {
            // IMPORTANT: "LONGBLOB" must be checked before "LONG" and "BLOB"
            return LONGBLOB;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "LONGTEXT") != -1) {
            // IMPORTANT: "LONGTEXT" must be checked before "LONG" and "TEXT"
            return LONGTEXT;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "MEDIUMBLOB") != -1 || StringUtil.indexOfIgnoreCase(typeName, "LONG VARBINARY") != -1) {
            // IMPORTANT: "MEDIUMBLOB" must be checked before "BLOB"
            // IMPORTANT: "LONG VARBINARY" must be checked before "LONG" and "VARBINARY"
            return MEDIUMBLOB;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "MEDIUMTEXT") != -1 || StringUtil.indexOfIgnoreCase(typeName, "LONG VARCHAR") != -1
                || StringUtil.indexOfIgnoreCase(typeName, "LONG") != -1) {
            // IMPORTANT: "MEDIUMTEXT" must be checked before "TEXT"
            // IMPORTANT: "LONG VARCHAR" must be checked before "VARCHAR"
            return MEDIUMTEXT;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "VARCHAR") != -1 || StringUtil.indexOfIgnoreCase(typeName, "NVARCHAR") != -1
                || StringUtil.indexOfIgnoreCase(typeName, "NATIONAL VARCHAR") != -1 || StringUtil.indexOfIgnoreCase(typeName, "CHARACTER VARYING") != -1) {
            // IMPORTANT: "CHARACTER VARYING" must be checked before "CHARACTER" and "CHAR"
            return VARCHAR;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "VARBINARY") != -1) {
            return VARBINARY;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "BINARY") != -1 || StringUtil.indexOfIgnoreCase(typeName, "CHAR BYTE") != -1) {
            // IMPORTANT: "BINARY" must be checked after all "*BINARY" types
            // IMPORTANT: "CHAR BYTE" must be checked before "CHAR"
            return BINARY;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "LINESTRING") != -1) {
            // also covers "MULTILINESTRING"
            // IMPORTANT: "LINESTRING" must be checked before "STRING"
            return GEOMETRY;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "STRING") != -1
                // IMPORTANT: "CHAR" must be checked after all "*CHAR*" types
                || StringUtil.indexOfIgnoreCase(typeName, "CHAR") != -1 || StringUtil.indexOfIgnoreCase(typeName, "NCHAR") != -1
                || StringUtil.indexOfIgnoreCase(typeName, "NATIONAL CHAR") != -1 || StringUtil.indexOfIgnoreCase(typeName, "CHARACTER") != -1) {
            return CHAR;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "BOOLEAN") != -1 || StringUtil.indexOfIgnoreCase(typeName, "BOOL") != -1) {
            return BOOLEAN;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "BIT") != -1) {
            return BIT;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "JSON") != -1) {
            return JSON;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "ENUM") != -1) {
            return ENUM;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "SET") != -1) {
            return SET;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "BLOB") != -1) {
            return BLOB;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "TEXT") != -1) {
            return TEXT;

        } else if (StringUtil.indexOfIgnoreCase(typeName, "GEOM") != -1 // covers "GEOMETRY", "GEOMETRYCOLLECTION" and "GEOMCOLLECTION"
                || StringUtil.indexOfIgnoreCase(typeName, "POINT") != -1 // also covers "MULTIPOINT"
                || StringUtil.indexOfIgnoreCase(typeName, "POLYGON") != -1 // also covers "MULTIPOLYGON"
        ) {
            return GEOMETRY; // TODO think about different MysqlTypes for Spatial Data Types
    ...
    public static JdbcSqlType getByJdbcType(int jdbcType) {
        switch (jdbcType) {
            case Types.BIGINT:
                return BIGINT;
            case Types.BINARY:
    ...
    public static boolean isSigned(JdbcSqlType type) {
        switch (type) {
            case DECIMAL:
            case TINYINT:
            case SMALLINT:
     ...
     *            params
     */
    private JdbcSqlType(String mysqlTypeName, int jdbcType, Class<?> javaClass, int allowedFlags, boolean isDec, Long precision, String createParams) {
